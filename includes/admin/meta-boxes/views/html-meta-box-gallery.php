...
<button class="button" id="app_meta_box_gallery_select"><?php echo App::lang( 'general_select' ); ?></button>
<button class="button" id="app_meta_box_gallery_removeall"><?php echo App::lang( 'general_delete_all' ); ?></button>
